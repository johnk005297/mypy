...
class Parser():
    ...
    def get_parser(cls):
        ...
        list_vm_parser.add_argument('-f', '--filter', required=False, help='Filter VMs by occurrences in the name. It uses regular expressions')
        ...
        show_snap_parser.add_argument('-f', '--filter', required=True, help='Filter VMs by occurrences in the name. It uses regular expressions')
        ...
        revert_snap_parser.add_argument('-f', '--filter', required=False, help='Filter VMs by occurrences in the name. It uses regular expressions')
        ...
        remove_snap_parser.add_argument('-f', '--filter', required=False, help='Filter VMs by occurrences in the name. It uses regular expressions')
        ...
        take_snap_parser.add_argument('-f', '--filter', required=True, help='Filter VMs by occurrences in the name. It uses regular expressions')
        ...
        start_vm_parser.add_argument('-f', '--filter', required=True, help='Filter VMs by occurrences in the name. It uses regular expressions')
        ...
        stop_vm_parser.add_argument('-f', '--filter', required=True, help='Filter VMs by occurrences in the name. It uses regular expressions')
        ...
        restart_vm_group.add_argument('-f', '--filter', required=False, help='Filter VMs by occurrences in the name. It uses regular expressions')
        ...
        sql_parser.add_argument('--print', required=False, action='store_true', help='Print list of matviews on a screen')
