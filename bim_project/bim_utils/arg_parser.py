...
class Parser():
    ...
    def parse_args(cls):
        ...
        vcenter_parser = subparser.add_parser('vsphere', help='Performing operations with vSphere API')
        ...
        restart_vm_parser.add_argument('--exclude-vm', type=str, nargs='+', required=False, help='A list of VMs to be excluded from the reboot OS')
