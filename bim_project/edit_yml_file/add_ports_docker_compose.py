...
def alter_yml():
    ...
    lst:list = []  # Creating a list of .yml file in format ['first string', 'second string', etc]
    array_for_exclude: tuple = ('ports:','80:5000','443:5001','8081:5000','8087:5000','8085:5000','8084:5000','8082:5000','8089:5000','5432:5432','5433:5432','8080:5000','9000:9000','5103:5000',
    ...
    for index in range(len(lst)):
        if lst[index].strip() == 'services:':
            count_spaces_next_line_for_service = len(lst[index+1]) - len(lst[index+1].lstrip(' ')) # calculate amount of whitespaces to the left of the next string
            break
    ...
    for index in range(len(lst)):
        ...
        elif " "*count_spaces_next_line_for_service +  "enterprise_asset_management_db:"  == current_str:
            lst.insert(index+1, " "*count_spaces_next_line + ports + " "*count_spaces_next_line + "- \"0.0.0.0:5444:5432\"\n")
